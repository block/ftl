...
type Changeset struct {
	...
	// Once this changeset is commited this is no longer canonical and it kept for archival purposes.
	...
	// Once the changeset is commited this becomes the canonical state of the removing modules
