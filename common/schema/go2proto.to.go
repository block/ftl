...
func (x *DeploymentRuntimeEvent) ToProto() *destpb.DeploymentRuntimeEvent {
	...
	return &destpb.DeploymentRuntimeEvent{
		...
		Realm:     orZero(ptr(string(x.Realm))),
	}
}
...
func DeploymentRuntimeEventFromProto(v *destpb.DeploymentRuntimeEvent) (out *DeploymentRuntimeEvent, err error) {
	...
	if out.Realm, err = orZeroR(result.From(ptr(string(v.Realm)), nil)).Result(); err != nil {
...
func (x *MetadataGenerated) ToProto() *destpb.MetadataGenerated {
	if x == nil {
		return nil
	}
	return &destpb.MetadataGenerated{
		Pos: x.Pos.ToProto(),
	}
}
