...
type DatabaseRuntimeConnectionsEvent struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Connections   *DatabaseRuntimeConnections `protobuf:"bytes,1,opt,name=connections,proto3" json:"connections,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DatabaseRuntimeConnectionsEvent) Reset() {
	*x = DatabaseRuntimeConnectionsEvent{}
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DatabaseRuntimeConnectionsEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabaseRuntimeConnectionsEvent) ProtoMessage() {}

func (x *DatabaseRuntimeConnectionsEvent) ProtoReflect() protoreflect.Message {
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabaseRuntimeConnectionsEvent.ProtoReflect.Descriptor instead.
func (*DatabaseRuntimeConnectionsEvent) Descriptor() ([]byte, []int) {
	return file_xyz_block_ftl_schema_v1_schema_proto_rawDescGZIP(), []int{13}
}

func (x *DatabaseRuntimeConnectionsEvent) GetConnections() *DatabaseRuntimeConnections {
	if x != nil {
		return x.Connections
	}
	return nil
...
type DatabaseRuntimeEvent struct {
	...
	Payload       *DatabaseRuntimeEventPayload `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DatabaseRuntimeEvent) GetPayload() *DatabaseRuntimeEventPayload {
	if x != nil {
		return x.Payload
	}
	return nil
...
type DatabaseRuntimeEventPayload struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Value:
	//
	//	*DatabaseRuntimeEventPayload_DatabaseRuntimeConnectionsEvent
	Value         isDatabaseRuntimeEventPayload_Value `protobuf_oneof:"value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DatabaseRuntimeEventPayload) Reset() {
	*x = DatabaseRuntimeEventPayload{}
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DatabaseRuntimeEventPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatabaseRuntimeEventPayload) ProtoMessage() {}

func (x *DatabaseRuntimeEventPayload) ProtoReflect() protoreflect.Message {
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatabaseRuntimeEventPayload.ProtoReflect.Descriptor instead.
func (*DatabaseRuntimeEventPayload) Descriptor() ([]byte, []int) {
	return file_xyz_block_ftl_schema_v1_schema_proto_rawDescGZIP(), []int{15}
}

func (x *DatabaseRuntimeEventPayload) GetValue() isDatabaseRuntimeEventPayload_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *DatabaseRuntimeEventPayload) GetDatabaseRuntimeConnectionsEvent() *DatabaseRuntimeConnectionsEvent {
	if x != nil {
		if x, ok := x.Value.(*DatabaseRuntimeEventPayload_DatabaseRuntimeConnectionsEvent); ok {
			return x.DatabaseRuntimeConnectionsEvent
		}
	}
	return nil
}

type isDatabaseRuntimeEventPayload_Value interface {
	isDatabaseRuntimeEventPayload_Value()
}

type DatabaseRuntimeEventPayload_DatabaseRuntimeConnectionsEvent struct {
	DatabaseRuntimeConnectionsEvent *DatabaseRuntimeConnectionsEvent `protobuf:"bytes,1,opt,name=database_runtime_connections_event,json=databaseRuntimeConnectionsEvent,proto3,oneof"`
}
...
type ModuleRuntimeEvent struct {
	...
	// Types that are valid to be assigned to Value:
	//
	//	*ModuleRuntimeEvent_ModuleRuntimeBase
	//	*ModuleRuntimeEvent_ModuleRuntimeDeployment
	//	*ModuleRuntimeEvent_ModuleRuntimeScaling
	Value         isModuleRuntimeEvent_Value `protobuf_oneof:"value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ModuleRuntimeEvent) GetValue() isModuleRuntimeEvent_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *ModuleRuntimeEvent) GetModuleRuntimeBase() *ModuleRuntimeBase {
	if x != nil {
		if x, ok := x.Value.(*ModuleRuntimeEvent_ModuleRuntimeBase); ok {
			return x.ModuleRuntimeBase
		}
	}
	return nil
}

func (x *ModuleRuntimeEvent) GetModuleRuntimeDeployment() *ModuleRuntimeDeployment {
	if x != nil {
		if x, ok := x.Value.(*ModuleRuntimeEvent_ModuleRuntimeDeployment); ok {
...
func (x *ModuleRuntimeEvent) GetModuleRuntimeScaling() *ModuleRuntimeScaling {
	if x != nil {
		if x, ok := x.Value.(*ModuleRuntimeEvent_ModuleRuntimeScaling); ok {
...
type isModuleRuntimeEvent_Value interface {
	isModuleRuntimeEvent_Value()
}

type ModuleRuntimeEvent_ModuleRuntimeBase struct {
	ModuleRuntimeBase *ModuleRuntimeBase `protobuf:"bytes,1,opt,name=module_runtime_base,json=moduleRuntimeBase,proto3,oneof"`
}

type ModuleRuntimeEvent_ModuleRuntimeDeployment struct {
	ModuleRuntimeDeployment *ModuleRuntimeDeployment `protobuf:"bytes,3,opt,name=module_runtime_deployment,json=moduleRuntimeDeployment,proto3,oneof"`
}

type ModuleRuntimeEvent_ModuleRuntimeScaling struct {
...
func (*ModuleRuntimeEvent_ModuleRuntimeBase) isModuleRuntimeEvent_Value() {}

func (*ModuleRuntimeEvent_ModuleRuntimeDeployment) isModuleRuntimeEvent_Value() {}

func (*ModuleRuntimeEvent_ModuleRuntimeScaling) isModuleRuntimeEvent_Value() {}
...
type RuntimeEvent struct {
	...
	//	*RuntimeEvent_ModuleRuntimeBase
	//	*RuntimeEvent_ModuleRuntimeDeployment
	//	*RuntimeEvent_ModuleRuntimeScaling
...
func (x *RuntimeEvent) GetModuleRuntimeBase() *ModuleRuntimeBase {
	if x != nil {
		if x, ok := x.Value.(*RuntimeEvent_ModuleRuntimeBase); ok {
			return x.ModuleRuntimeBase
		}
	}
	return nil
...
func (x *RuntimeEvent) GetModuleRuntimeDeployment() *ModuleRuntimeDeployment {
	if x != nil {
		if x, ok := x.Value.(*RuntimeEvent_ModuleRuntimeDeployment); ok {
			return x.ModuleRuntimeDeployment
		}
	}
	return nil
...
func (x *RuntimeEvent) GetModuleRuntimeScaling() *ModuleRuntimeScaling {
	if x != nil {
		if x, ok := x.Value.(*RuntimeEvent_ModuleRuntimeScaling); ok {
			return x.ModuleRuntimeScaling
		}
	}
	return nil
...
type RuntimeEvent_DatabaseRuntimeEvent struct {
	DatabaseRuntimeEvent *DatabaseRuntimeEvent `protobuf:"bytes,5,opt,name=database_runtime_event,json=databaseRuntimeEvent,proto3,oneof"`
}

type RuntimeEvent_ModuleRuntimeBase struct {
	ModuleRuntimeBase *ModuleRuntimeBase `protobuf:"bytes,1,opt,name=module_runtime_base,json=moduleRuntimeBase,proto3,oneof"`
}

type RuntimeEvent_ModuleRuntimeDeployment struct {
	ModuleRuntimeDeployment *ModuleRuntimeDeployment `protobuf:"bytes,3,opt,name=module_runtime_deployment,json=moduleRuntimeDeployment,proto3,oneof"`
}

type RuntimeEvent_ModuleRuntimeScaling struct {
	ModuleRuntimeScaling *ModuleRuntimeScaling `protobuf:"bytes,2,opt,name=module_runtime_scaling,json=moduleRuntimeScaling,proto3,oneof"`
}

type RuntimeEvent_TopicRuntimeEvent struct {
	TopicRuntimeEvent *TopicRuntimeEvent `protobuf:"bytes,6,opt,name=topic_runtime_event,json=topicRuntimeEvent,proto3,oneof"`
}

type RuntimeEvent_VerbRuntimeEvent struct {
	VerbRuntimeEvent *VerbRuntimeEvent `protobuf:"bytes,4,opt,name=verb_runtime_event,json=verbRuntimeEvent,proto3,oneof"`
}

func (*RuntimeEvent_DatabaseRuntimeEvent) isRuntimeEvent_Value() {}

func (*RuntimeEvent_ModuleRuntimeBase) isRuntimeEvent_Value() {}

func (*RuntimeEvent_ModuleRuntimeDeployment) isRuntimeEvent_Value() {}

func (*RuntimeEvent_ModuleRuntimeScaling) isRuntimeEvent_Value() {}
...
type TopicRuntimeEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Payload       *TopicRuntime          `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VerbRuntimeEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Payload       *VerbRuntimePayload    `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VerbRuntimeEvent) GetPayload() *VerbRuntimePayload {
	if x != nil {
		return x.Payload
	}
	return nil
...
type VerbRuntimePayload struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Value:
	//
	//	*VerbRuntimePayload_VerbRuntimeBase
	//	*VerbRuntimePayload_VerbRuntimeSubscription
	Value         isVerbRuntimePayload_Value `protobuf_oneof:"value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VerbRuntimePayload) Reset() {
	*x = VerbRuntimePayload{}
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerbRuntimePayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerbRuntimePayload) ProtoMessage() {}

func (x *VerbRuntimePayload) ProtoReflect() protoreflect.Message {
	mi := &file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[73]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerbRuntimePayload.ProtoReflect.Descriptor instead.
func (*VerbRuntimePayload) Descriptor() ([]byte, []int) {
	return file_xyz_block_ftl_schema_v1_schema_proto_rawDescGZIP(), []int{73}
}

func (x *VerbRuntimePayload) GetValue() isVerbRuntimePayload_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *VerbRuntimePayload) GetVerbRuntimeBase() *VerbRuntimeBase {
	if x != nil {
		if x, ok := x.Value.(*VerbRuntimePayload_VerbRuntimeBase); ok {
			return x.VerbRuntimeBase
		}
	}
	return nil
}

func (x *VerbRuntimePayload) GetVerbRuntimeSubscription() *VerbRuntimeSubscription {
	if x != nil {
		if x, ok := x.Value.(*VerbRuntimePayload_VerbRuntimeSubscription); ok {
			return x.VerbRuntimeSubscription
		}
	}
	return nil
}

type isVerbRuntimePayload_Value interface {
	isVerbRuntimePayload_Value()
}

type VerbRuntimePayload_VerbRuntimeBase struct {
	VerbRuntimeBase *VerbRuntimeBase `protobuf:"bytes,1,opt,name=verb_runtime_base,json=verbRuntimeBase,proto3,oneof"`
}

type VerbRuntimePayload_VerbRuntimeSubscription struct {
	VerbRuntimeSubscription *VerbRuntimeSubscription `protobuf:"bytes,2,opt,name=verb_runtime_subscription,json=verbRuntimeSubscription,proto3,oneof"`
}

func (*VerbRuntimePayload_VerbRuntimeBase) isVerbRuntimePayload_Value() {}

func (*VerbRuntimePayload_VerbRuntimeSubscription) isVerbRuntimePayload_Value() {}
...
var file_xyz_block_ftl_schema_v1_schema_proto_rawDesc = []byte{
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x70, 0x6f, 0x73, 0x22, 0xeb,
	...
	0x68, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0xec, 0x01, 0x0a, 0x17,
	...
	,
	...
	0x63, 0x61, 0x6c, 0x69, 0x6e, 0x67, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22,
	...
	0x74, 0x65, 0x72, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x70, 0x6f, 0x73, 0x22, 0xec, 0x04, 0x0a,
	0x0c, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x65, 0x0a,
	0x16, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	0x65, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e,
	0x78, 0x79, 0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x66, 0x74, 0x6c, 0x2e, 0x73, 0x63,
	...
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x5c, 0x0a, 0x13, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x72,
	0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x6c, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x61, 0x73, 0x65, 0x48, 0x00, 0x52,
	0x11, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x61,
	0x73, 0x65, 0x12, 0x6e, 0x0a, 0x19, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x72, 0x75, 0x6e,
	...
	,
	...
	0x6e, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x06,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x38, 0x0a, 0x03, 0x70, 0x6f, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x78, 0x79, 0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e,
	0x66, 0x74, 0x6c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x03, 0x70, 0x6f, 0x73, 0x88, 0x01, 0x01,
	...
	0x6c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f, 0x64, 0x75,
	0x6c, 0x65, 0x52, 0x07, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x5f,
	0x70, 0x6f, 0x73, 0x22, 0xad, 0x01, 0x0a, 0x06, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x38,
	0x0a, 0x03, 0x70, 0x6f, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x78, 0x79,
	0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x66, 0x74, 0x6c, 0x2e, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00,
	0x52, 0x03, 0x70, 0x6f, 0x73, 0x88, 0x01, 0x01, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x33, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x78, 0x79, 0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e,
	0x66, 0x74, 0x6c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x3d, 0x0a, 0x08, 0x6d, 0x65, 0x74,
	...
	0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x22, 0x4e, 0x0a, 0x0c,
	0x54, 0x6f, 0x70, 0x69, 0x63, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x49, 0x64, 0x22, 0x64, 0x0a, 0x11,
	...
	0x69, 0x63, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x22, 0x9a, 0x05, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x30, 0x0a, 0x03, 0x61,
	...
	0x73, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xb7, 0x01,
	0x0a, 0x0b, 0x56, 0x65, 0x72, 0x62, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x3c, 0x0a,
	0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x78, 0x79,
	0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x66, 0x74, 0x6c, 0x2e, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x62, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	0x65, 0x42, 0x61, 0x73, 0x65, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65, 0x12, 0x59, 0x0a, 0x0c, 0x73,
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb2, 0x01, 0x0a, 0x0f, 0x56, 0x65, 0x72, 0x62,
	0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x61, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0b, 0x63,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x3e, 0x0a,
	...
	,
	...
	,
	...
	0x53, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x4a, 0x53, 0x4f, 0x4e, 0x10, 0x01, 0x2a, 0x8e, 0x01,
	...
	0x00, 0x12, 0x20, 0x0a, 0x1c, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x53, 0x45, 0x54, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x56, 0x49, 0x53, 0x49, 0x4f, 0x4e, 0x49, 0x4e,
	0x47, 0x10, 0x01, 0x12, 0x1d, 0x0a, 0x19, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x53, 0x45, 0x54,
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x43, 0x4f, 0x4d, 0x4d, 0x49, 0x54, 0x54, 0x45, 0x44,
	0x10, 0x02, 0x12, 0x1a, 0x0a, 0x16, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x53, 0x45, 0x54, 0x5f,
	0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x5c,
...
var file_xyz_block_ftl_schema_v1_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_xyz_block_ftl_schema_v1_schema_proto_goTypes = []any{
	...
	(*DatabaseRuntimeConnectionsEvent)(nil), // 16: xyz.block.ftl.schema.v1.DatabaseRuntimeConnectionsEvent
	(*DatabaseRuntimeEvent)(nil),            // 17: xyz.block.ftl.schema.v1.DatabaseRuntimeEvent
	(*DatabaseRuntimeEventPayload)(nil),     // 18: xyz.block.ftl.schema.v1.DatabaseRuntimeEventPayload
	(*Decl)(nil),                            // 19: xyz.block.ftl.schema.v1.Decl
	(*Enum)(nil),                            // 20: xyz.block.ftl.schema.v1.Enum
	(*EnumVariant)(nil),                     // 21: xyz.block.ftl.schema.v1.EnumVariant
	(*Field)(nil),                           // 22: xyz.block.ftl.schema.v1.Field
	(*Float)(nil),                           // 23: xyz.block.ftl.schema.v1.Float
	(*IngressPathComponent)(nil),            // 24: xyz.block.ftl.schema.v1.IngressPathComponent
	(*IngressPathLiteral)(nil),              // 25: xyz.block.ftl.schema.v1.IngressPathLiteral
	(*IngressPathParameter)(nil),            // 26: xyz.block.ftl.schema.v1.IngressPathParameter
	(*Int)(nil),                             // 27: xyz.block.ftl.schema.v1.Int
	(*IntValue)(nil),                        // 28: xyz.block.ftl.schema.v1.IntValue
	(*Map)(nil),                             // 29: xyz.block.ftl.schema.v1.Map
	(*Metadata)(nil),                        // 30: xyz.block.ftl.schema.v1.Metadata
	(*MetadataAlias)(nil),                   // 31: xyz.block.ftl.schema.v1.MetadataAlias
	(*MetadataArtefact)(nil),                // 32: xyz.block.ftl.schema.v1.MetadataArtefact
	(*MetadataCalls)(nil),                   // 33: xyz.block.ftl.schema.v1.MetadataCalls
	(*MetadataConfig)(nil),                  // 34: xyz.block.ftl.schema.v1.MetadataConfig
	(*MetadataCronJob)(nil),                 // 35: xyz.block.ftl.schema.v1.MetadataCronJob
	(*MetadataDatabases)(nil),               // 36: xyz.block.ftl.schema.v1.MetadataDatabases
	(*MetadataEncoding)(nil),                // 37: xyz.block.ftl.schema.v1.MetadataEncoding
	(*MetadataIngress)(nil),                 // 38: xyz.block.ftl.schema.v1.MetadataIngress
	(*MetadataPartitions)(nil),              // 39: xyz.block.ftl.schema.v1.MetadataPartitions
	(*MetadataPublisher)(nil),               // 40: xyz.block.ftl.schema.v1.MetadataPublisher
	(*MetadataRetry)(nil),                   // 41: xyz.block.ftl.schema.v1.MetadataRetry
	(*MetadataSQLColumn)(nil),               // 42: xyz.block.ftl.schema.v1.MetadataSQLColumn
	(*MetadataSQLMigration)(nil),            // 43: xyz.block.ftl.schema.v1.MetadataSQLMigration
	(*MetadataSQLQuery)(nil),                // 44: xyz.block.ftl.schema.v1.MetadataSQLQuery
	(*MetadataSecrets)(nil),                 // 45: xyz.block.ftl.schema.v1.MetadataSecrets
	(*MetadataSubscriber)(nil),              // 46: xyz.block.ftl.schema.v1.MetadataSubscriber
	(*MetadataTypeMap)(nil),                 // 47: xyz.block.ftl.schema.v1.MetadataTypeMap
	(*Module)(nil),                          // 48: xyz.block.ftl.schema.v1.Module
	(*ModuleRuntime)(nil),                   // 49: xyz.block.ftl.schema.v1.ModuleRuntime
	(*ModuleRuntimeBase)(nil),               // 50: xyz.block.ftl.schema.v1.ModuleRuntimeBase
	(*ModuleRuntimeDeployment)(nil),         // 51: xyz.block.ftl.schema.v1.ModuleRuntimeDeployment
	(*ModuleRuntimeEvent)(nil),              // 52: xyz.block.ftl.schema.v1.ModuleRuntimeEvent
	(*ModuleRuntimeScaling)(nil),            // 53: xyz.block.ftl.schema.v1.ModuleRuntimeScaling
	(*Optional)(nil),                        // 54: xyz.block.ftl.schema.v1.Optional
	(*Position)(nil),                        // 55: xyz.block.ftl.schema.v1.Position
	(*Ref)(nil),                             // 56: xyz.block.ftl.schema.v1.Ref
	(*RuntimeEvent)(nil),                    // 57: xyz.block.ftl.schema.v1.RuntimeEvent
	(*Schema)(nil),                          // 58: xyz.block.ftl.schema.v1.Schema
	(*Secret)(nil),                          // 59: xyz.block.ftl.schema.v1.Secret
	(*String)(nil),                          // 60: xyz.block.ftl.schema.v1.String
	(*StringValue)(nil),                     // 61: xyz.block.ftl.schema.v1.StringValue
	(*Time)(nil),                            // 62: xyz.block.ftl.schema.v1.Time
	(*Topic)(nil),                           // 63: xyz.block.ftl.schema.v1.Topic
	(*TopicRuntime)(nil),                    // 64: xyz.block.ftl.schema.v1.TopicRuntime
	(*TopicRuntimeEvent)(nil),               // 65: xyz.block.ftl.schema.v1.TopicRuntimeEvent
	(*Type)(nil),                            // 66: xyz.block.ftl.schema.v1.Type
	(*TypeAlias)(nil),                       // 67: xyz.block.ftl.schema.v1.TypeAlias
	(*TypeParameter)(nil),                   // 68: xyz.block.ftl.schema.v1.TypeParameter
	(*TypeValue)(nil),                       // 69: xyz.block.ftl.schema.v1.TypeValue
	(*Unit)(nil),                            // 70: xyz.block.ftl.schema.v1.Unit
	(*Value)(nil),                           // 71: xyz.block.ftl.schema.v1.Value
	(*Verb)(nil),                            // 72: xyz.block.ftl.schema.v1.Verb
	(*VerbRuntime)(nil),                     // 73: xyz.block.ftl.schema.v1.VerbRuntime
	(*VerbRuntimeBase)(nil),                 // 74: xyz.block.ftl.schema.v1.VerbRuntimeBase
	(*VerbRuntimeEvent)(nil),                // 75: xyz.block.ftl.schema.v1.VerbRuntimeEvent
	(*VerbRuntimePayload)(nil),              // 76: xyz.block.ftl.schema.v1.VerbRuntimePayload
	(*VerbRuntimeSubscription)(nil),         // 77: xyz.block.ftl.schema.v1.VerbRuntimeSubscription
	(*timestamppb.Timestamp)(nil),           // 78: google.protobuf.Timestamp
}
var file_xyz_block_ftl_schema_v1_schema_proto_depIdxs = []int32{
	55,  // 0: xyz.block.ftl.schema.v1.AWSIAMAuthDatabaseConnector.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 1: xyz.block.ftl.schema.v1.Any.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 2: xyz.block.ftl.schema.v1.Array.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 3: xyz.block.ftl.schema.v1.Array.element:type_name -> xyz.block.ftl.schema.v1.Type
	55,  // 4: xyz.block.ftl.schema.v1.Bool.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 5: xyz.block.ftl.schema.v1.Bytes.pos:type_name -> xyz.block.ftl.schema.v1.Position
	78,  // 6: xyz.block.ftl.schema.v1.Changeset.created_at:type_name -> google.protobuf.Timestamp
	48,  // 7: xyz.block.ftl.schema.v1.Changeset.modules:type_name -> xyz.block.ftl.schema.v1.Module
	1,   // 8: xyz.block.ftl.schema.v1.Changeset.state:type_name -> xyz.block.ftl.schema.v1.ChangesetState
	55,  // 9: xyz.block.ftl.schema.v1.Config.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 10: xyz.block.ftl.schema.v1.Config.type:type_name -> xyz.block.ftl.schema.v1.Type
	55,  // 11: xyz.block.ftl.schema.v1.DSNDatabaseConnector.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 12: xyz.block.ftl.schema.v1.Data.pos:type_name -> xyz.block.ftl.schema.v1.Position
	68,  // 13: xyz.block.ftl.schema.v1.Data.type_parameters:type_name -> xyz.block.ftl.schema.v1.TypeParameter
	22,  // 14: xyz.block.ftl.schema.v1.Data.fields:type_name -> xyz.block.ftl.schema.v1.Field
	30,  // 15: xyz.block.ftl.schema.v1.Data.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	55,  // 16: xyz.block.ftl.schema.v1.Database.pos:type_name -> xyz.block.ftl.schema.v1.Position
	14,  // 17: xyz.block.ftl.schema.v1.Database.runtime:type_name -> xyz.block.ftl.schema.v1.DatabaseRuntime
	30,  // 18: xyz.block.ftl.schema.v1.Database.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	...
	15,  // 24: xyz.block.ftl.schema.v1.DatabaseRuntimeConnectionsEvent.connections:type_name -> xyz.block.ftl.schema.v1.DatabaseRuntimeConnections
	18,  // 25: xyz.block.ftl.schema.v1.DatabaseRuntimeEvent.payload:type_name -> xyz.block.ftl.schema.v1.DatabaseRuntimeEventPayload
	16,  // 26: xyz.block.ftl.schema.v1.DatabaseRuntimeEventPayload.database_runtime_connections_event:type_name -> xyz.block.ftl.schema.v1.DatabaseRuntimeConnectionsEvent
	9,   // 27: xyz.block.ftl.schema.v1.Decl.config:type_name -> xyz.block.ftl.schema.v1.Config
	11,  // 28: xyz.block.ftl.schema.v1.Decl.data:type_name -> xyz.block.ftl.schema.v1.Data
	12,  // 29: xyz.block.ftl.schema.v1.Decl.database:type_name -> xyz.block.ftl.schema.v1.Database
	20,  // 30: xyz.block.ftl.schema.v1.Decl.enum:type_name -> xyz.block.ftl.schema.v1.Enum
	59,  // 31: xyz.block.ftl.schema.v1.Decl.secret:type_name -> xyz.block.ftl.schema.v1.Secret
	63,  // 32: xyz.block.ftl.schema.v1.Decl.topic:type_name -> xyz.block.ftl.schema.v1.Topic
	67,  // 33: xyz.block.ftl.schema.v1.Decl.type_alias:type_name -> xyz.block.ftl.schema.v1.TypeAlias
	72,  // 34: xyz.block.ftl.schema.v1.Decl.verb:type_name -> xyz.block.ftl.schema.v1.Verb
	55,  // 35: xyz.block.ftl.schema.v1.Enum.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 36: xyz.block.ftl.schema.v1.Enum.type:type_name -> xyz.block.ftl.schema.v1.Type
	21,  // 37: xyz.block.ftl.schema.v1.Enum.variants:type_name -> xyz.block.ftl.schema.v1.EnumVariant
	55,  // 38: xyz.block.ftl.schema.v1.EnumVariant.pos:type_name -> xyz.block.ftl.schema.v1.Position
	71,  // 39: xyz.block.ftl.schema.v1.EnumVariant.value:type_name -> xyz.block.ftl.schema.v1.Value
	55,  // 40: xyz.block.ftl.schema.v1.Field.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 41: xyz.block.ftl.schema.v1.Field.type:type_name -> xyz.block.ftl.schema.v1.Type
	30,  // 42: xyz.block.ftl.schema.v1.Field.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	55,  // 43: xyz.block.ftl.schema.v1.Float.pos:type_name -> xyz.block.ftl.schema.v1.Position
	25,  // 44: xyz.block.ftl.schema.v1.IngressPathComponent.ingress_path_literal:type_name -> xyz.block.ftl.schema.v1.IngressPathLiteral
	26,  // 45: xyz.block.ftl.schema.v1.IngressPathComponent.ingress_path_parameter:type_name -> xyz.block.ftl.schema.v1.IngressPathParameter
	55,  // 46: xyz.block.ftl.schema.v1.IngressPathLiteral.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 47: xyz.block.ftl.schema.v1.IngressPathParameter.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 48: xyz.block.ftl.schema.v1.Int.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 49: xyz.block.ftl.schema.v1.IntValue.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 50: xyz.block.ftl.schema.v1.Map.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 51: xyz.block.ftl.schema.v1.Map.key:type_name -> xyz.block.ftl.schema.v1.Type
	66,  // 52: xyz.block.ftl.schema.v1.Map.value:type_name -> xyz.block.ftl.schema.v1.Type
	31,  // 53: xyz.block.ftl.schema.v1.Metadata.alias:type_name -> xyz.block.ftl.schema.v1.MetadataAlias
	32,  // 54: xyz.block.ftl.schema.v1.Metadata.artefact:type_name -> xyz.block.ftl.schema.v1.MetadataArtefact
	33,  // 55: xyz.block.ftl.schema.v1.Metadata.calls:type_name -> xyz.block.ftl.schema.v1.MetadataCalls
	34,  // 56: xyz.block.ftl.schema.v1.Metadata.config:type_name -> xyz.block.ftl.schema.v1.MetadataConfig
	35,  // 57: xyz.block.ftl.schema.v1.Metadata.cron_job:type_name -> xyz.block.ftl.schema.v1.MetadataCronJob
	36,  // 58: xyz.block.ftl.schema.v1.Metadata.databases:type_name -> xyz.block.ftl.schema.v1.MetadataDatabases
	37,  // 59: xyz.block.ftl.schema.v1.Metadata.encoding:type_name -> xyz.block.ftl.schema.v1.MetadataEncoding
	38,  // 60: xyz.block.ftl.schema.v1.Metadata.ingress:type_name -> xyz.block.ftl.schema.v1.MetadataIngress
	39,  // 61: xyz.block.ftl.schema.v1.Metadata.partitions:type_name -> xyz.block.ftl.schema.v1.MetadataPartitions
	40,  // 62: xyz.block.ftl.schema.v1.Metadata.publisher:type_name -> xyz.block.ftl.schema.v1.MetadataPublisher
	41,  // 63: xyz.block.ftl.schema.v1.Metadata.retry:type_name -> xyz.block.ftl.schema.v1.MetadataRetry
	42,  // 64: xyz.block.ftl.schema.v1.Metadata.sql_column:type_name -> xyz.block.ftl.schema.v1.MetadataSQLColumn
	43,  // 65: xyz.block.ftl.schema.v1.Metadata.sql_migration:type_name -> xyz.block.ftl.schema.v1.MetadataSQLMigration
	44,  // 66: xyz.block.ftl.schema.v1.Metadata.sql_query:type_name -> xyz.block.ftl.schema.v1.MetadataSQLQuery
	45,  // 67: xyz.block.ftl.schema.v1.Metadata.secrets:type_name -> xyz.block.ftl.schema.v1.MetadataSecrets
	46,  // 68: xyz.block.ftl.schema.v1.Metadata.subscriber:type_name -> xyz.block.ftl.schema.v1.MetadataSubscriber
	47,  // 69: xyz.block.ftl.schema.v1.Metadata.type_map:type_name -> xyz.block.ftl.schema.v1.MetadataTypeMap
	55,  // 70: xyz.block.ftl.schema.v1.MetadataAlias.pos:type_name -> xyz.block.ftl.schema.v1.Position
	0,   // 71: xyz.block.ftl.schema.v1.MetadataAlias.kind:type_name -> xyz.block.ftl.schema.v1.AliasKind
	55,  // 72: xyz.block.ftl.schema.v1.MetadataArtefact.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 73: xyz.block.ftl.schema.v1.MetadataCalls.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 74: xyz.block.ftl.schema.v1.MetadataCalls.calls:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 75: xyz.block.ftl.schema.v1.MetadataConfig.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 76: xyz.block.ftl.schema.v1.MetadataConfig.config:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 77: xyz.block.ftl.schema.v1.MetadataCronJob.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 78: xyz.block.ftl.schema.v1.MetadataDatabases.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 79: xyz.block.ftl.schema.v1.MetadataDatabases.calls:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 80: xyz.block.ftl.schema.v1.MetadataEncoding.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 81: xyz.block.ftl.schema.v1.MetadataIngress.pos:type_name -> xyz.block.ftl.schema.v1.Position
	24,  // 82: xyz.block.ftl.schema.v1.MetadataIngress.path:type_name -> xyz.block.ftl.schema.v1.IngressPathComponent
	55,  // 83: xyz.block.ftl.schema.v1.MetadataPartitions.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 84: xyz.block.ftl.schema.v1.MetadataPublisher.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 85: xyz.block.ftl.schema.v1.MetadataPublisher.topics:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 86: xyz.block.ftl.schema.v1.MetadataRetry.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 87: xyz.block.ftl.schema.v1.MetadataRetry.catch:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 88: xyz.block.ftl.schema.v1.MetadataSQLColumn.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 89: xyz.block.ftl.schema.v1.MetadataSQLMigration.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 90: xyz.block.ftl.schema.v1.MetadataSQLQuery.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 91: xyz.block.ftl.schema.v1.MetadataSecrets.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 92: xyz.block.ftl.schema.v1.MetadataSecrets.secrets:type_name -> xyz.block.ftl.schema.v1.Ref
	55,  // 93: xyz.block.ftl.schema.v1.MetadataSubscriber.pos:type_name -> xyz.block.ftl.schema.v1.Position
	56,  // 94: xyz.block.ftl.schema.v1.MetadataSubscriber.topic:type_name -> xyz.block.ftl.schema.v1.Ref
	2,   // 95: xyz.block.ftl.schema.v1.MetadataSubscriber.from_offset:type_name -> xyz.block.ftl.schema.v1.FromOffset
	55,  // 96: xyz.block.ftl.schema.v1.MetadataTypeMap.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 97: xyz.block.ftl.schema.v1.Module.pos:type_name -> xyz.block.ftl.schema.v1.Position
	30,  // 98: xyz.block.ftl.schema.v1.Module.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	19,  // 99: xyz.block.ftl.schema.v1.Module.decls:type_name -> xyz.block.ftl.schema.v1.Decl
	49,  // 100: xyz.block.ftl.schema.v1.Module.runtime:type_name -> xyz.block.ftl.schema.v1.ModuleRuntime
	50,  // 101: xyz.block.ftl.schema.v1.ModuleRuntime.base:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeBase
	53,  // 102: xyz.block.ftl.schema.v1.ModuleRuntime.scaling:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeScaling
	51,  // 103: xyz.block.ftl.schema.v1.ModuleRuntime.deployment:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeDeployment
	78,  // 104: xyz.block.ftl.schema.v1.ModuleRuntimeBase.create_time:type_name -> google.protobuf.Timestamp
	78,  // 105: xyz.block.ftl.schema.v1.ModuleRuntimeDeployment.created_at:type_name -> google.protobuf.Timestamp
	78,  // 106: xyz.block.ftl.schema.v1.ModuleRuntimeDeployment.activated_at:type_name -> google.protobuf.Timestamp
	50,  // 107: xyz.block.ftl.schema.v1.ModuleRuntimeEvent.module_runtime_base:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeBase
	51,  // 108: xyz.block.ftl.schema.v1.ModuleRuntimeEvent.module_runtime_deployment:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeDeployment
	53,  // 109: xyz.block.ftl.schema.v1.ModuleRuntimeEvent.module_runtime_scaling:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeScaling
	55,  // 110: xyz.block.ftl.schema.v1.Optional.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 111: xyz.block.ftl.schema.v1.Optional.type:type_name -> xyz.block.ftl.schema.v1.Type
	55,  // 112: xyz.block.ftl.schema.v1.Ref.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 113: xyz.block.ftl.schema.v1.Ref.type_parameters:type_name -> xyz.block.ftl.schema.v1.Type
	17,  // 114: xyz.block.ftl.schema.v1.RuntimeEvent.database_runtime_event:type_name -> xyz.block.ftl.schema.v1.DatabaseRuntimeEvent
	50,  // 115: xyz.block.ftl.schema.v1.RuntimeEvent.module_runtime_base:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeBase
	51,  // 116: xyz.block.ftl.schema.v1.RuntimeEvent.module_runtime_deployment:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeDeployment
	53,  // 117: xyz.block.ftl.schema.v1.RuntimeEvent.module_runtime_scaling:type_name -> xyz.block.ftl.schema.v1.ModuleRuntimeScaling
	65,  // 118: xyz.block.ftl.schema.v1.RuntimeEvent.topic_runtime_event:type_name -> xyz.block.ftl.schema.v1.TopicRuntimeEvent
	75,  // 119: xyz.block.ftl.schema.v1.RuntimeEvent.verb_runtime_event:type_name -> xyz.block.ftl.schema.v1.VerbRuntimeEvent
	55,  // 120: xyz.block.ftl.schema.v1.Schema.pos:type_name -> xyz.block.ftl.schema.v1.Position
	48,  // 121: xyz.block.ftl.schema.v1.Schema.modules:type_name -> xyz.block.ftl.schema.v1.Module
	55,  // 122: xyz.block.ftl.schema.v1.Secret.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 123: xyz.block.ftl.schema.v1.Secret.type:type_name -> xyz.block.ftl.schema.v1.Type
	55,  // 124: xyz.block.ftl.schema.v1.String.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 125: xyz.block.ftl.schema.v1.StringValue.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 126: xyz.block.ftl.schema.v1.Time.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 127: xyz.block.ftl.schema.v1.Topic.pos:type_name -> xyz.block.ftl.schema.v1.Position
	64,  // 128: xyz.block.ftl.schema.v1.Topic.runtime:type_name -> xyz.block.ftl.schema.v1.TopicRuntime
	66,  // 129: xyz.block.ftl.schema.v1.Topic.event:type_name -> xyz.block.ftl.schema.v1.Type
	30,  // 130: xyz.block.ftl.schema.v1.Topic.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	64,  // 131: xyz.block.ftl.schema.v1.TopicRuntimeEvent.payload:type_name -> xyz.block.ftl.schema.v1.TopicRuntime
	4,   // 132: xyz.block.ftl.schema.v1.Type.any:type_name -> xyz.block.ftl.schema.v1.Any
	5,   // 133: xyz.block.ftl.schema.v1.Type.array:type_name -> xyz.block.ftl.schema.v1.Array
	6,   // 134: xyz.block.ftl.schema.v1.Type.bool:type_name -> xyz.block.ftl.schema.v1.Bool
	7,   // 135: xyz.block.ftl.schema.v1.Type.bytes:type_name -> xyz.block.ftl.schema.v1.Bytes
	23,  // 136: xyz.block.ftl.schema.v1.Type.float:type_name -> xyz.block.ftl.schema.v1.Float
	27,  // 137: xyz.block.ftl.schema.v1.Type.int:type_name -> xyz.block.ftl.schema.v1.Int
	29,  // 138: xyz.block.ftl.schema.v1.Type.map:type_name -> xyz.block.ftl.schema.v1.Map
	54,  // 139: xyz.block.ftl.schema.v1.Type.optional:type_name -> xyz.block.ftl.schema.v1.Optional
	56,  // 140: xyz.block.ftl.schema.v1.Type.ref:type_name -> xyz.block.ftl.schema.v1.Ref
	60,  // 141: xyz.block.ftl.schema.v1.Type.string:type_name -> xyz.block.ftl.schema.v1.String
	62,  // 142: xyz.block.ftl.schema.v1.Type.time:type_name -> xyz.block.ftl.schema.v1.Time
	70,  // 143: xyz.block.ftl.schema.v1.Type.unit:type_name -> xyz.block.ftl.schema.v1.Unit
	55,  // 144: xyz.block.ftl.schema.v1.TypeAlias.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 145: xyz.block.ftl.schema.v1.TypeAlias.type:type_name -> xyz.block.ftl.schema.v1.Type
	30,  // 146: xyz.block.ftl.schema.v1.TypeAlias.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	55,  // 147: xyz.block.ftl.schema.v1.TypeParameter.pos:type_name -> xyz.block.ftl.schema.v1.Position
	55,  // 148: xyz.block.ftl.schema.v1.TypeValue.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 149: xyz.block.ftl.schema.v1.TypeValue.value:type_name -> xyz.block.ftl.schema.v1.Type
	55,  // 150: xyz.block.ftl.schema.v1.Unit.pos:type_name -> xyz.block.ftl.schema.v1.Position
	28,  // 151: xyz.block.ftl.schema.v1.Value.int_value:type_name -> xyz.block.ftl.schema.v1.IntValue
	61,  // 152: xyz.block.ftl.schema.v1.Value.string_value:type_name -> xyz.block.ftl.schema.v1.StringValue
	69,  // 153: xyz.block.ftl.schema.v1.Value.type_value:type_name -> xyz.block.ftl.schema.v1.TypeValue
	55,  // 154: xyz.block.ftl.schema.v1.Verb.pos:type_name -> xyz.block.ftl.schema.v1.Position
	66,  // 155: xyz.block.ftl.schema.v1.Verb.request:type_name -> xyz.block.ftl.schema.v1.Type
	66,  // 156: xyz.block.ftl.schema.v1.Verb.response:type_name -> xyz.block.ftl.schema.v1.Type
	30,  // 157: xyz.block.ftl.schema.v1.Verb.metadata:type_name -> xyz.block.ftl.schema.v1.Metadata
	73,  // 158: xyz.block.ftl.schema.v1.Verb.runtime:type_name -> xyz.block.ftl.schema.v1.VerbRuntime
	74,  // 159: xyz.block.ftl.schema.v1.VerbRuntime.base:type_name -> xyz.block.ftl.schema.v1.VerbRuntimeBase
	77,  // 160: xyz.block.ftl.schema.v1.VerbRuntime.subscription:type_name -> xyz.block.ftl.schema.v1.VerbRuntimeSubscription
	78,  // 161: xyz.block.ftl.schema.v1.VerbRuntimeBase.create_time:type_name -> google.protobuf.Timestamp
	78,  // 162: xyz.block.ftl.schema.v1.VerbRuntimeBase.start_time:type_name -> google.protobuf.Timestamp
	76,  // 163: xyz.block.ftl.schema.v1.VerbRuntimeEvent.payload:type_name -> xyz.block.ftl.schema.v1.VerbRuntimePayload
	74,  // 164: xyz.block.ftl.schema.v1.VerbRuntimePayload.verb_runtime_base:type_name -> xyz.block.ftl.schema.v1.VerbRuntimeBase
	77,  // 165: xyz.block.ftl.schema.v1.VerbRuntimePayload.verb_runtime_subscription:type_name -> xyz.block.ftl.schema.v1.VerbRuntimeSubscription
...
func file_xyz_block_ftl_schema_v1_schema_proto_init() {
	...
	file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[15].OneofWrappers = []any{
		(*DatabaseRuntimeEventPayload_DatabaseRuntimeConnectionsEvent)(nil),
	}
	...
	file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[49].OneofWrappers = []any{
		(*ModuleRuntimeEvent_ModuleRuntimeBase)(nil),
		(*ModuleRuntimeEvent_ModuleRuntimeDeployment)(nil),
		(*ModuleRuntimeEvent_ModuleRuntimeScaling)(nil),
	}
	...
	file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[54].OneofWrappers = []any{
		...
		(*RuntimeEvent_ModuleRuntimeBase)(nil),
		(*RuntimeEvent_ModuleRuntimeDeployment)(nil),
		(*RuntimeEvent_ModuleRuntimeScaling)(nil),
	...
	file_xyz_block_ftl_schema_v1_schema_proto_msgTypes[73].OneofWrappers = []any{
		(*VerbRuntimePayload_VerbRuntimeBase)(nil),
		(*VerbRuntimePayload_VerbRuntimeSubscription)(nil),
	}
	type x struct{}
