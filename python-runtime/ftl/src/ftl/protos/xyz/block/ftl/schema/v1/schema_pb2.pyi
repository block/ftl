...
class MetadataFixture(_message.Message):
    __slots__ = ("pos", "manual")
    POS_FIELD_NUMBER: _ClassVar[int]
    MANUAL_FIELD_NUMBER: _ClassVar[int]
    pos: Position
    manual: bool
    def __init__(self, pos: _Optional[_Union[Position, _Mapping]] = ..., manual: bool = ...) -> None: ...
...
class Type(_message.Message):
    __slots__ = ("any", "array", "bool", "bytes", "data", "enum", "field", "float", "int", "map", "optional", "ref", "string", "time", "type_alias", "unit")
