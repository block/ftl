...
class Event(_message.Message):
    __slots__ = ("timestamp", "id", "log", "call", "ingress", "cron_scheduled", "pubsub_publish", "pubsub_consume", "changeset_created", "changeset_state_changed", "deployment_runtime")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., id: _Optional[int] = ..., log: _Optional[_Union[LogEvent, _Mapping]] = ..., call: _Optional[_Union[CallEvent, _Mapping]] = ..., ingress: _Optional[_Union[IngressEvent, _Mapping]] = ..., cron_scheduled: _Optional[_Union[CronScheduledEvent, _Mapping]] = ..., pubsub_publish: _Optional[_Union[PubSubPublishEvent, _Mapping]] = ..., pubsub_consume: _Optional[_Union[PubSubConsumeEvent, _Mapping]] = ..., changeset_created: _Optional[_Union[ChangesetCreatedEvent, _Mapping]] = ..., changeset_state_changed: _Optional[_Union[ChangesetStateChangedEvent, _Mapping]] = ..., deployment_runtime: _Optional[_Union[DeploymentRuntimeEvent, _Mapping]] = ...) -> None: ...
