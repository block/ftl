...
class BuildSuccess(_message.Message):
    __slots__ = ("context_id", "is_automatic_rebuild", "module", "deploy", "docker_image", "errors", "dev_endpoint", "debug_port", "dev_hot_reload_endpoint")
    CONTEXT_ID_FIELD_NUMBER: _ClassVar[int]
