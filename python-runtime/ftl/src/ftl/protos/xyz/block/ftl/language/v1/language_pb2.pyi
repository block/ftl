...
class ModuleConfig(_message.Message):
    __slots__ = ("name", "dir", "language", "deploy_dir", "build", "dev_mode_build", "build_lock", "watch", "language_config", "sql_migration_dir", "sql_query_dir")
...
class BuildContext(_message.Message):
    __slots__ = ("id", "module_config", "schema", "dependencies", "build_env", "os", "arch")
    ...
    os: str
    arch: str
    def __init__(self, id: _Optional[str] = ..., module_config: _Optional[_Union[ModuleConfig, _Mapping]] = ..., schema: _Optional[_Union[_schema_pb2.Schema, _Mapping]] = ..., dependencies: _Optional[_Iterable[str]] = ..., build_env: _Optional[_Iterable[str]] = ..., os: _Optional[str] = ..., arch: _Optional[str] = ...) -> None: ...
...
class BuildSuccess(_message.Message):
    __slots__ = ("context_id", "is_automatic_rebuild", "module", "deploy", "docker_image", "errors", "dev_endpoint", "debug_port", "dev_hot_reload_endpoint", "dev_hot_reload_version")
    CONTEXT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    DEV_HOT_RELOAD_ENDPOINT_FIELD_NUMBER: _ClassVar[int]
    DEV_HOT_RELOAD_VERSION_FIELD_NUMBER: _ClassVar[int]
    context_id: str
