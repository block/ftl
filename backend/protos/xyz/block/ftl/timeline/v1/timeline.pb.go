...
func (x *CreateEventsRequest_EventEntry) GetAsyncExecute() *AsyncExecuteEvent {
	if x != nil {
		if x, ok := x.Entry.(*CreateEventsRequest_EventEntry_AsyncExecute); ok {
...
type CreateEventsRequest_EventEntry_AsyncExecute struct {
	AsyncExecute *AsyncExecuteEvent `protobuf:"bytes,6,opt,name=async_execute,json=asyncExecute,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_PubsubPublish struct {
	PubsubPublish *PubSubPublishEvent `protobuf:"bytes,7,opt,name=pubsub_publish,json=pubsubPublish,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_PubsubConsume struct {
	PubsubConsume *PubSubConsumeEvent `protobuf:"bytes,8,opt,name=pubsub_consume,json=pubsubConsume,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_ChangesetCreated struct {
	ChangesetCreated *ChangesetCreatedEvent `protobuf:"bytes,9,opt,name=changeset_created,json=changesetCreated,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_ChangesetStateChanged struct {
	ChangesetStateChanged *ChangesetStateChangedEvent `protobuf:"bytes,10,opt,name=changeset_state_changed,json=changesetStateChanged,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_DeploymentRuntime struct {
	DeploymentRuntime *DeploymentRuntimeEvent `protobuf:"bytes,11,opt,name=deployment_runtime,json=deploymentRuntime,proto3,oneof"`
}
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_rawDesc = string([]byte{
	...
	0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x89, 0x08, 0x0a, 0x13, 0x43, 0x72,
	...
	0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x1a, 0x9c, 0x07, 0x0a, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x78, 0x79, 0x7a, 0x2e, 0x62,
	...
	0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d,
	0x2e, 0x78, 0x79, 0x7a, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x66, 0x74, 0x6c, 0x2e, 0x74,
	...
	0x73, 0x65, 0x74, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28,
	...
	0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x78, 0x79, 0x7a, 0x2e, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x2e, 0x66, 0x74, 0x6c, 0x2e, 0x74, 0x69, 0x6d, 0x65, 0x6c, 0x69, 0x6e,
	...
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0b,
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_goTypes = []any{
	...
	(*AsyncExecuteEvent)(nil),                   // 29: xyz.block.ftl.timeline.v1.AsyncExecuteEvent
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_depIdxs = []int32{
	...
	29, // 26: xyz.block.ftl.timeline.v1.CreateEventsRequest.EventEntry.async_execute:type_name -> xyz.block.ftl.timeline.v1.AsyncExecuteEvent
	...
	1,  // 33: xyz.block.ftl.timeline.v1.TimelineService.GetTimeline:input_type -> xyz.block.ftl.timeline.v1.GetTimelineRequest
	3,  // 34: xyz.block.ftl.timeline.v1.TimelineService.StreamTimeline:input_type -> xyz.block.ftl.timeline.v1.StreamTimelineRequest
	5,  // 35: xyz.block.ftl.timeline.v1.TimelineService.CreateEvents:input_type -> xyz.block.ftl.timeline.v1.CreateEventsRequest
	7,  // 36: xyz.block.ftl.timeline.v1.TimelineService.DeleteOldEvents:input_type -> xyz.block.ftl.timeline.v1.DeleteOldEventsRequest
	36, // 37: xyz.block.ftl.timeline.v1.TimelineService.Ping:output_type -> xyz.block.ftl.v1.PingResponse
	2,  // 38: xyz.block.ftl.timeline.v1.TimelineService.GetTimeline:output_type -> xyz.block.ftl.timeline.v1.GetTimelineResponse
	4,  // 39: xyz.block.ftl.timeline.v1.TimelineService.StreamTimeline:output_type -> xyz.block.ftl.timeline.v1.StreamTimelineResponse
	6,  // 40: xyz.block.ftl.timeline.v1.TimelineService.CreateEvents:output_type -> xyz.block.ftl.timeline.v1.CreateEventsResponse
	8,  // 41: xyz.block.ftl.timeline.v1.TimelineService.DeleteOldEvents:output_type -> xyz.block.ftl.timeline.v1.DeleteOldEventsResponse
