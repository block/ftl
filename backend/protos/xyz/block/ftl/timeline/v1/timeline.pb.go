...
func (x *CreateEventsRequest_EventEntry) GetDeploymentCreated() *DeploymentCreatedEvent {
	if x != nil {
		if x, ok := x.Entry.(*CreateEventsRequest_EventEntry_DeploymentCreated); ok {
...
type CreateEventsRequest_EventEntry_DeploymentCreated struct {
	DeploymentCreated *DeploymentCreatedEvent `protobuf:"bytes,11,opt,name=deployment_created,json=deploymentCreated,proto3,oneof"`
}

type CreateEventsRequest_EventEntry_DeploymentRuntime struct {
	DeploymentRuntime *DeploymentRuntimeEvent `protobuf:"bytes,12,opt,name=deployment_runtime,json=deploymentRuntime,proto3,oneof"`
}
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_rawDesc = string([]byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xed, 0x08, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x65, 0x73, 0x1a, 0x80, 0x08, 0x0a, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x45, 0x6e, 0x74, 0x72,
	...
	0x6e, 0x74, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b,
	...
	0x74, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x62, 0x0a, 0x12, 0x64, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0c,
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_goTypes = []any{
	...
	(*DeploymentCreatedEvent)(nil),              // 33: xyz.block.ftl.timeline.v1.DeploymentCreatedEvent
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_depIdxs = []int32{
	...
	33, // 30: xyz.block.ftl.timeline.v1.CreateEventsRequest.EventEntry.deployment_created:type_name -> xyz.block.ftl.timeline.v1.DeploymentCreatedEvent
