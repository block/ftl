...
func (x *CreateEventsRequest_EventEntry) GetDeploymentUpdated() *DeploymentUpdatedEvent {
	if x != nil {
		if x, ok := x.Entry.(*CreateEventsRequest_EventEntry_DeploymentUpdated); ok {
...
var file_xyz_block_ftl_timeline_v1_timeline_proto_rawDesc = string([]byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x4c, 0x50, 0x01, 0x5a, 0x48, 0x67, 0x69, 0x74, 0x68,
	...
	0x78, 0x79, 0x7a, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2f, 0x66, 0x74, 0x6c, 0x2f, 0x74, 0x69,
