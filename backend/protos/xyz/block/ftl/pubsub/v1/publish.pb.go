...
const file_xyz_block_ftl_pubsub_v1_publish_proto_rawDesc = "" +
	"\n" +
	...
	"\x13PublishEventRequest\x122\n" +
	"\x05topic\x18\x01 \x01(\v2\x1c.xyz.block.ftl.schema.v1.RefR\x05topic\x12\x12\n" +
	"\x04body\x18\x02 \x01(\fR\x04body\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\x12\x16\n" +
	"\x06caller\x18\x04 \x01(\tR\x06caller\"\x16\n" +
	...
	"\fPublishEvent\x12,.xyz.block.ftl.pubsub.v1.PublishEventRequest\x1a-.xyz.block.ftl.pubsub.v1.PublishEventResponseBHP\x01ZDgithub.com/block/ftl/backend/protos/xyz/block/ftl/pubsub/v1;pubsubpbb\x06proto3"
