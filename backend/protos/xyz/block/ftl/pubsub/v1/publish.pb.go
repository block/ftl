...
var file_xyz_block_ftl_pubsub_v1_publish_proto_rawDesc = []byte{
...
var (
	...
	file_xyz_block_ftl_pubsub_v1_publish_proto_rawDescData = file_xyz_block_ftl_pubsub_v1_publish_proto_rawDesc
)
...
func file_xyz_block_ftl_pubsub_v1_publish_proto_rawDescGZIP() []byte {
	file_xyz_block_ftl_pubsub_v1_publish_proto_rawDescOnce.Do(func() {
		file_xyz_block_ftl_pubsub_v1_publish_proto_rawDescData = protoimpl.X.CompressGZIP(file_xyz_block_ftl_pubsub_v1_publish_proto_rawDescData)
	})
...
func file_xyz_block_ftl_pubsub_v1_publish_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_xyz_block_ftl_pubsub_v1_publish_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_xyz_block_ftl_pubsub_v1_publish_proto_rawDesc = nil
