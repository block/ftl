...
// NewPublishServiceClient constructs a client for the xyz.block.ftl.pubsub.v1.PublishService
...
// Ping calls xyz.block.ftl.pubsub.v1.PublishService.Ping.
...
// PublishEvent calls xyz.block.ftl.pubsub.v1.PublishService.PublishEvent.
...
func (UnimplementedPublishServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xyz.block.ftl.pubsub.v1.PublishService.Ping is not implemented"))
}
...
func (UnimplementedPublishServiceHandler) PublishEvent(context.Context, *connect.Request[v11.PublishEventRequest]) (*connect.Response[v11.PublishEventResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xyz.block.ftl.pubsub.v1.PublishService.PublishEvent is not implemented"))
}
