...
const file_xyz_block_ftl_v1_controller_proto_rawDesc = "" +
	"\n" +
	...
	"deployment\x12/\n" +
	"\x06labels\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06labels\"\x18\n" +
	"\x16RegisterRunnerResponse\"\x0f\n" +
	"\rStatusRequest\"\xfc\x06\n" +
	"\x0eStatusResponse\x12M\n" +
	"\vcontrollers\x18\x01 \x03(\v2+.xyz.block.ftl.v1.StatusResponse.ControllerR\vcontrollers\x12A\n" +
	"\arunners\x18\x02 \x03(\v2'.xyz.block.ftl.v1.StatusResponse.RunnerR\arunners\x12M\n" +
	"\vdeployments\x18\x03 \x03(\v2+.xyz.block.ftl.v1.StatusResponse.DeploymentR\vdeployments\x12>\n" +
	"\x06routes\x18\x05 \x03(\v2&.xyz.block.ftl.v1.StatusResponse.RouteR\x06routes\x1aT\n" +
	"\n" +
	"Controller\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x1a\x9b\x01\n" +
	"\x06Runner\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1a\n" +
	...
	"\x06labels\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x06labelsB\r\n" +
	"\v_deployment\x1a\xf7\x01\n" +
	"\n" +
	"Deployment\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12!\n" +
	"\fmin_replicas\x18\x04 \x01(\x05R\vminReplicas\x12\x1a\n" +
	"\breplicas\x18\a \x01(\x05R\breplicas\x12/\n" +
	"\x06labels\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06labels\x127\n" +
	"\x06schema\x18\x06 \x01(\v2\x1f.xyz.block.ftl.schema.v1.ModuleR\x06schema\x1a[\n" +
	"\x05Route\x12\x16\n" +
	"\x06module\x18\x01 \x01(\tR\x06module\x12\x1e\n" +
	"\n" +
	"deployment\x18\x02 \x01(\tR\n" +
	"deployment\x12\x1a\n" +
	"\bendpoint\x18\x03 \x01(\tR\bendpoint\"\x14\n" +
	"\x12ProcessListRequest\"\xaf\x03\n" +
	"\x13ProcessListResponse\x12K\n" +
	"\tprocesses\x18\x01 \x03(\v2-.xyz.block.ftl.v1.ProcessListResponse.ProcessR\tprocesses\x1an\n" +
	"\rProcessRunner\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x1a\n" +
	"\bendpoint\x18\x02 \x01(\tR\bendpoint\x12/\n" +
	"\x06labels\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06labels\x1a\xda\x01\n" +
	"\aProcess\x12\x1e\n" +
	"\n" +
	"deployment\x18\x01 \x01(\tR\n" +
	"deployment\x12!\n" +
	"\fmin_replicas\x18\x02 \x01(\x05R\vminReplicas\x12/\n" +
	"\x06labels\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x06labels\x12P\n" +
	"\x06runner\x18\x04 \x01(\v23.xyz.block.ftl.v1.ProcessListResponse.ProcessRunnerH\x00R\x06runner\x88\x01\x01B\t\n" +
	"\a_runner\"=\n" +
	...
	"\rDB_TYPE_MYSQL\x10\x022\xe8\x03\n" +
	...
	"\vProcessList\x12$.xyz.block.ftl.v1.ProcessListRequest\x1a%.xyz.block.ftl.v1.ProcessListResponse\x12K\n" +
	"\x06Status\x12\x1f.xyz.block.ftl.v1.StatusRequest\x1a .xyz.block.ftl.v1.StatusResponse\x12w\n" +
	"\x14GetDeploymentContext\x12-.xyz.block.ftl.v1.GetDeploymentContextRequest\x1a..xyz.block.ftl.v1.GetDeploymentContextResponse0\x01\x12e\n" +
	"\x0eRegisterRunner\x12'.xyz.block.ftl.v1.RegisterRunnerRequest\x1a(.xyz.block.ftl.v1.RegisterRunnerResponse(\x01B>P\x01Z:github.com/block/ftl/backend/protos/xyz/block/ftl/v1;ftlv1b\x06proto3"
