...
var file_xyz_block_ftl_v1_controller_proto_rawDesc = string([]byte{
	...
	0x32, 0xef, 0x02, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x53,
	...
	0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x65, 0x0a, 0x0e, 0x52,
	...
	0x28, 0x01, 0x42, 0x3e, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_xyz_block_ftl_v1_controller_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_xyz_block_ftl_v1_controller_proto_goTypes = []any{
	(*RegisterRunnerRequest)(nil),             // 0: xyz.block.ftl.v1.RegisterRunnerRequest
	(*RegisterRunnerResponse)(nil),            // 1: xyz.block.ftl.v1.RegisterRunnerResponse
	(*StatusRequest)(nil),                     // 2: xyz.block.ftl.v1.StatusRequest
	(*StatusResponse)(nil),                    // 3: xyz.block.ftl.v1.StatusResponse
	(*ProcessListRequest)(nil),                // 4: xyz.block.ftl.v1.ProcessListRequest
	(*ProcessListResponse)(nil),               // 5: xyz.block.ftl.v1.ProcessListResponse
	(*StatusResponse_Controller)(nil),         // 6: xyz.block.ftl.v1.StatusResponse.Controller
	(*StatusResponse_Runner)(nil),             // 7: xyz.block.ftl.v1.StatusResponse.Runner
	(*StatusResponse_Deployment)(nil),         // 8: xyz.block.ftl.v1.StatusResponse.Deployment
	(*StatusResponse_Route)(nil),              // 9: xyz.block.ftl.v1.StatusResponse.Route
	(*ProcessListResponse_ProcessRunner)(nil), // 10: xyz.block.ftl.v1.ProcessListResponse.ProcessRunner
	(*ProcessListResponse_Process)(nil),       // 11: xyz.block.ftl.v1.ProcessListResponse.Process
	(*structpb.Struct)(nil),                   // 12: google.protobuf.Struct
	(*v1.Module)(nil),                         // 13: xyz.block.ftl.schema.v1.Module
	(*PingRequest)(nil),                       // 14: xyz.block.ftl.v1.PingRequest
	(*PingResponse)(nil),                      // 15: xyz.block.ftl.v1.PingResponse
}
var file_xyz_block_ftl_v1_controller_proto_depIdxs = []int32{
	12, // 0: xyz.block.ftl.v1.RegisterRunnerRequest.labels:type_name -> google.protobuf.Struct
	6,  // 1: xyz.block.ftl.v1.StatusResponse.controllers:type_name -> xyz.block.ftl.v1.StatusResponse.Controller
	7,  // 2: xyz.block.ftl.v1.StatusResponse.runners:type_name -> xyz.block.ftl.v1.StatusResponse.Runner
	8,  // 3: xyz.block.ftl.v1.StatusResponse.deployments:type_name -> xyz.block.ftl.v1.StatusResponse.Deployment
	9,  // 4: xyz.block.ftl.v1.StatusResponse.routes:type_name -> xyz.block.ftl.v1.StatusResponse.Route
	11, // 5: xyz.block.ftl.v1.ProcessListResponse.processes:type_name -> xyz.block.ftl.v1.ProcessListResponse.Process
	12, // 6: xyz.block.ftl.v1.StatusResponse.Runner.labels:type_name -> google.protobuf.Struct
	12, // 7: xyz.block.ftl.v1.StatusResponse.Deployment.labels:type_name -> google.protobuf.Struct
	13, // 8: xyz.block.ftl.v1.StatusResponse.Deployment.schema:type_name -> xyz.block.ftl.schema.v1.Module
	12, // 9: xyz.block.ftl.v1.ProcessListResponse.ProcessRunner.labels:type_name -> google.protobuf.Struct
	12, // 10: xyz.block.ftl.v1.ProcessListResponse.Process.labels:type_name -> google.protobuf.Struct
	10, // 11: xyz.block.ftl.v1.ProcessListResponse.Process.runner:type_name -> xyz.block.ftl.v1.ProcessListResponse.ProcessRunner
	14, // 12: xyz.block.ftl.v1.ControllerService.Ping:input_type -> xyz.block.ftl.v1.PingRequest
	4,  // 13: xyz.block.ftl.v1.ControllerService.ProcessList:input_type -> xyz.block.ftl.v1.ProcessListRequest
	2,  // 14: xyz.block.ftl.v1.ControllerService.Status:input_type -> xyz.block.ftl.v1.StatusRequest
	0,  // 15: xyz.block.ftl.v1.ControllerService.RegisterRunner:input_type -> xyz.block.ftl.v1.RegisterRunnerRequest
	15, // 16: xyz.block.ftl.v1.ControllerService.Ping:output_type -> xyz.block.ftl.v1.PingResponse
	5,  // 17: xyz.block.ftl.v1.ControllerService.ProcessList:output_type -> xyz.block.ftl.v1.ProcessListResponse
	3,  // 18: xyz.block.ftl.v1.ControllerService.Status:output_type -> xyz.block.ftl.v1.StatusResponse
	1,  // 19: xyz.block.ftl.v1.ControllerService.RegisterRunner:output_type -> xyz.block.ftl.v1.RegisterRunnerResponse
...
func file_xyz_block_ftl_v1_controller_proto_init() {
	...
	file_xyz_block_ftl_v1_controller_proto_msgTypes[11].OneofWrappers = []any{}
	type x struct{}
