...
var file_xyz_block_ftl_provisioner_v1beta1_service_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xdc, 0x03, 0x0a, 0x12, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f,
	...
	0x6e, 0x73, 0x65, 0x12, 0x5d, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x70,
	...
	0x73, 0x65, 0x42, 0x57, 0x50, 0x01, 0x5a, 0x53, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2f, 0x66, 0x74, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x3b, 0x70, 0x72,
	0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_xyz_block_ftl_provisioner_v1beta1_service_proto_goTypes = []any{
	...
	(*v1.UpdateDeployRequest)(nil),      // 4: xyz.block.ftl.v1.UpdateDeployRequest
	(*v1.PingResponse)(nil),             // 5: xyz.block.ftl.v1.PingResponse
	(*v1.StatusResponse)(nil),           // 6: xyz.block.ftl.v1.StatusResponse
	(*v1.GetArtefactDiffsResponse)(nil), // 7: xyz.block.ftl.v1.GetArtefactDiffsResponse
	(*v1.UploadArtefactResponse)(nil),   // 8: xyz.block.ftl.v1.UploadArtefactResponse
	(*v1.UpdateDeployResponse)(nil),     // 9: xyz.block.ftl.v1.UpdateDeployResponse
}
var file_xyz_block_ftl_provisioner_v1beta1_service_proto_depIdxs = []int32{
	...
	4, // 4: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.UpdateDeploy:input_type -> xyz.block.ftl.v1.UpdateDeployRequest
	5, // 5: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.Ping:output_type -> xyz.block.ftl.v1.PingResponse
	6, // 6: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.Status:output_type -> xyz.block.ftl.v1.StatusResponse
	7, // 7: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.GetArtefactDiffs:output_type -> xyz.block.ftl.v1.GetArtefactDiffsResponse
	8, // 8: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.UploadArtefact:output_type -> xyz.block.ftl.v1.UploadArtefactResponse
	9, // 9: xyz.block.ftl.provisioner.v1beta1.ProvisionerService.UpdateDeploy:output_type -> xyz.block.ftl.v1.UpdateDeployResponse
