...
const file_xyz_block_ftl_cron_v1_cron_proto_rawDesc = "" +
	"\n" +
	" xyz/block/ftl/cron/v1/cron.proto\x12\x15xyz.block.ftl.cron.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x03\n" +
	"\tCronState\x12]\n" +
	"\x0flast_executions\x18\x01 \x03(\v24.xyz.block.ftl.cron.v1.CronState.LastExecutionsEntryR\x0elastExecutions\x12]\n" +
	"\x0fnext_executions\x18\x02 \x03(\v24.xyz.block.ftl.cron.v1.CronState.NextExecutionsEntryR\x0enextExecutions\x1a]\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x05value:\x028\x01BBZ@github.com/block/ftl/backend/protos/xyz/block/ftl/cron/v1;cronpbb\x06proto3"
