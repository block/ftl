...
func NewK8sScaling(disableIstio bool, instanceName string, mapper kube.NamespaceMapper, cronServiceAccount string, adminServiceAccount string, consoleServiceAccount string, httpServiceAccount string) scaling.RunnerScaling {
...
func (r *k8sScaling) TerminateDeployment(ctx context.Context, deploymentKey string) error {
	...
	serviceClient := r.client.CoreV1().Services(r.namespaceMapper(dk.Payload.Module, dk.Payload.Realm))
