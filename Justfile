...
JVM_RUNTIME_IN :=  "jvm-runtime/ftl-runtime/pom.xml " + \
  ...
  "jvm-runtime/ftl-runtime/kotlin/compiler-plugin/src " + \
  "jvm-runtime/ftl-runtime/kotlin/compiler-plugin/pom.xml " + \
...
JVM_RUNTIME_OUT := "jvm-runtime/ftl-runtime/java/runtime/target/ftl-java-runtime-1.0-SNAPSHOT.jar " + \
  ...
  "jvm-runtime/ftl-runtime/kotlin/compiler-plugin/target/ftl-kotlin-compiler-plugin-1.0-SNAPSHOT.jar " + \
