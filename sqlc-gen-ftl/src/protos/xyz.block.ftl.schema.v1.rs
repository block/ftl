...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Event {
    #[prost(oneof="event::Value", tags="5, 3, 6, 9, 7, 4, 8, 2")]
...
pub mod metadata {
    ...
    pub enum Value {
        ...
        Transaction(super::MetadataTransaction),
        #[prost(message, tag="8")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PlaintextKafkaSubscriptionConnector {
