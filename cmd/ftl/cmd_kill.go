...
func (k *killCmd) Run(ctx context.Context, client adminpbconnect.AdminServiceClient, source *schemaeventsource.EventSource, projectConfig projectconfig.Config) error {
