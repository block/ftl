...
export const sortMultiselectOpts = (o: MultiselectOpt[]) => o.sort((a: MultiselectOpt, b: MultiselectOpt) => (a.key < b.key ? -1 : 1))
...
const getGroupsFromOpts = (opts: MultiselectOpt[]): string[] => [...new Set(opts.map((o) => o.group).filter((g) => !!g))] as string[]
