...
export class GetCreateModuleFlagsRequest extends Message<GetCreateModuleFlagsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.language.v1.GetCreateModuleFlagsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message xyz.block.ftl.language.v1.GetCreateModuleFlagsResponse
 */
export class GetCreateModuleFlagsResponse extends Message<GetCreateModuleFlagsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.language.v1.GetCreateModuleFlagsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message xyz.block.ftl.language.v1.GetCreateModuleFlagsResponse.Flag
 */
export class GetCreateModuleFlagsResponse_Flag extends Message<GetCreateModuleFlagsResponse_Flag> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.language.v1.GetCreateModuleFlagsResponse.Flag";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message xyz.block.ftl.language.v1.CreateModuleRequest
 */
...
export class ModuleConfigDefaultsRequest extends Message<ModuleConfigDefaultsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.language.v1.ModuleConfigDefaultsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "dir", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message xyz.block.ftl.language.v1.ModuleConfigDefaultsResponse
 */
export class ModuleConfigDefaultsResponse extends Message<ModuleConfigDefaultsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.language.v1.ModuleConfigDefaultsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
