...
export class DeploymentRuntimeEvent extends Message<DeploymentRuntimeEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.schema.v1.DeploymentRuntimeEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Event extends Message<Event> {
  ...
  value: {
    /**
     * @generated from field: xyz.block.ftl.schema.v1.ChangesetCommittedEvent changeset_committed_event = 5;
     */
    value: ChangesetCommittedEvent;
    case: "changesetCommittedEvent";
  } | {
    /**
     * @generated from field: xyz.block.ftl.schema.v1.ChangesetCreatedEvent changeset_created_event = 3;
     */
    value: ChangesetCreatedEvent;
    case: "changesetCreatedEvent";
  } | {
    /**
     * @generated from field: xyz.block.ftl.schema.v1.ChangesetDrainedEvent changeset_drained_event = 6;
     */
    ...
    /**
     * @generated from field: xyz.block.ftl.schema.v1.ChangesetFinalizedEvent changeset_finalized_event = 7;
     */
    value: ChangesetFinalizedEvent;
    case: "changesetFinalizedEvent";
  } | {
    /**
     * @generated from field: xyz.block.ftl.schema.v1.ChangesetPreparedEvent changeset_prepared_event = 4;
     */
...
export class MetadataDatabases extends Message<MetadataDatabases> {
  ...
  /**
   * @generated from field: repeated xyz.block.ftl.schema.v1.Ref uses = 2;
   */
  uses: Ref[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pos", kind: "message", T: Position, opt: true },
    { no: 2, name: "uses", kind: "message", T: Ref, repeated: true },
  ]);
 ...
 *
 * @generated from message xyz.block.ftl.schema.v1.MetadataGenerated
 */
export class MetadataGenerated extends Message<MetadataGenerated> {
  /**
   * @generated from field: optional xyz.block.ftl.schema.v1.Position pos = 1;
   */
  pos?: Position;

  constructor(data?: PartialMessage<MetadataGenerated>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.schema.v1.MetadataGenerated";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pos", kind: "message", T: Position, opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MetadataGenerated {
    return new MetadataGenerated().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MetadataGenerated {
    return new MetadataGenerated().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MetadataGenerated {
    return new MetadataGenerated().fromJsonString(jsonString, options);
  }
