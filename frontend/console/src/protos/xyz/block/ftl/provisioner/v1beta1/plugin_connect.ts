...
import { DeProvisionRequest, DeProvisionResponse, ProvisionRequest, ProvisionResponse, StatusRequest, StatusResponse } from "./plugin_pb.js";
...
export const ProvisionerPluginService = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc xyz.block.ftl.provisioner.v1beta1.ProvisionerPluginService.DeProvision
     */
    deProvision: {
      name: "DeProvision",
      I: DeProvisionRequest,
      O: DeProvisionResponse,
      kind: MethodKind.Unary,
    },
    /**
